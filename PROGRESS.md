...
| Status | Scope | Issue |
| --- | --- | --- |
| ✅ | Implement minimal E-Key issuer (EKS) service | [#1](https://github.com/NishizukaKoichi/ephemeral-proof-bound-key/issues/1) |
| ✅ | Add resource-server verification middleware | [#2](https://github.com/NishizukaKoichi/ephemeral-proof-bound-key/issues/2) |
| ✅ | Provide DPoP proof helper and client SDK | [#3](https://github.com/NishizukaKoichi/ephemeral-proof-bound-key/issues/3) |
